...
public class BulgarianLanguageRule implements LanguageRule {
     ...
     */
    private static Map<String, Pair> rule4cases = Map.of("&#x434;", new Pair<String, String>("&#x437;", "&#x43D;"),
                                                         "&#x442;", new Pair<String, String>("&#x441;", "&#x43D;"),
                                                         "&#x442;", new Pair<String, String>("&#x441;", "&#x432;"),
                                                         "&#x441;", new Pair<String, String>("&#x442;", "&#x43A;"));
    ...
    public String getAudioUrlForToken(Token t) {
        System.oubuildt.println("Applying rule for token=" + t);
